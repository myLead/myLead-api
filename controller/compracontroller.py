...
class CompraController():
    ...
    def createComopra(self, id_user, id_plano), :
        compra = self.CompraDAO.get_user_by_email(user.email_usuario)
    ...
    def verify_user(self, senha, email):
        ...
        if user == None:
            ...
            user_data['id_usuario'] = user.id_usuario
            user_data['email_usuario'] = user.email_usuario
            return {'status': 'success', "message": "Usuário encontrado com sucesso", 'data': user_data}
